...
Page({
  ...
  tabChange(e){
    ...
    const sid = this.data.tabList[index].id
    this.get_product_list(true, sid);
  },
  ...
  */
  ...
  //查找产品
  get_product_list: function (isPage,index = "") {
    var that = this;
    this.setWhere(index);
  ...
  getAllCategory: function () {
    ...
    app.baseGet(app.U({ c: 'store_api', a: "get_product_category" }),         function (res) {
      ...
      that.get_product_list(true,sid)
    })
  },
  /**
   * 生命周期函数--监听页面初次渲染完成
